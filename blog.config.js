...
const BLOG = {
  ...
  RANDOM_IMAGE_URL: process.env.NEXT_PUBLIC_RANDOM_IMAGE_URL || 'https://cdn.pixabay.com/photo/2024/05/13/19/19/ufo-8759621_1280.png', // 随机图片API,如果未配置下面的关键字，主页封面，头像，文章封面图都会被替换为随机图片
